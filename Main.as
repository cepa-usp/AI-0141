package  
{
	...
	public class Main extends MovieClip
	{
		...
		private function init(e:Event = null):void 
		{
			...
			var ttinfo:ToolTip = new ToolTip(botaoInfo, "Informações", 0.5, 0.5);
			addChild(ttinfo);
			var ttreset:ToolTip = new ToolTip(botaoReset, "Nova tentativa", 0.5, 0.5);
			addChild(ttreset);
			var ttcc:ToolTip = new ToolTip(botaoAbout, "Créditos", 0.5, 0.5);
			addChild(ttcc);
			
			var ttThumbnail1:ToolTip = new ToolTip(thumbnail1, "Átomo", 0.5, 0.5);
			addChild(ttThumbnail1);
			var ttThumbnail2:ToolTip = new ToolTip(thumbnail2, "Molécula", 0.5, 0.5);
			addChild(ttThumbnail2);
			var ttThumbnail3:ToolTip = new ToolTip(thumbnail3, "Organela", 0.5, 0.5);
			addChild(ttThumbnail3);
			var ttThumbnail4:ToolTip = new ToolTip(thumbnail4, "Célula", 0.5, 0.5);
			addChild(ttThumbnail4);
			var ttThumbnail5:ToolTip = new ToolTip(thumbnail5, "Tecido", 0.5, 0.5);
			addChild(ttThumbnail5);
			var ttThumbnail6:ToolTip = new ToolTip(thumbnail6, "Órgão", 0.5, 0.5);
			addChild(ttThumbnail6);
			var ttThumbnail7:ToolTip = new ToolTip(thumbnail7, "Sistema de órgãos", 0.5, 0.5);
			addChild(ttThumbnail7);
			var ttThumbnail8:ToolTip = new ToolTip(thumbnail8, "Organismo", 0.5, 0.5);
			addChild(ttThumbnail8);
			var ttThumbnail9:ToolTip = new ToolTip(thumbnail9, "População", 0.5, 0.5);
			addChild(ttThumbnail9);
			var ttThumbnail10:ToolTip = new ToolTip(thumbnail10, "Comunidade", 0.5, 0.5);
			addChild(ttThumbnail10);
			var ttThumbnail11:ToolTip = new ToolTip(thumbnail11, "Ecossistema", 0.5, 0.5);
			addChild(ttThumbnail11);
			
			var ttImagem1:ToolTip = new ToolTip(imagem1, "Átomo", 0.5, 0.5);
			addChild(ttImagem1);
			var ttImagem2:ToolTip = new ToolTip(imagem2, "Molécula", 0.5, 0.5);
			addChild(ttImagem2);
			var ttImagem3:ToolTip = new ToolTip(imagem3, "Organela", 0.5, 0.5);
			addChild(ttImagem3);
			var ttImagem4:ToolTip = new ToolTip(imagem4, "Célula", 0.5, 0.5);
			addChild(ttImagem4);
			var ttImagem5:ToolTip = new ToolTip(imagem5, "Tecido", 0.5, 0.5);
			addChild(ttImagem5);
			var ttImagem6:ToolTip = new ToolTip(imagem6, "Órgão", 0.5, 0.5);
			addChild(ttImagem6);
			var ttImagem7:ToolTip = new ToolTip(imagem7, "Sistema de órgãos", 0.5, 0.5);
			addChild(ttImagem7);
			var ttImagem8:ToolTip = new ToolTip(imagem8, "Organismo", 0.5, 0.5);
			addChild(ttImagem8);
			var ttImagem9:ToolTip = new ToolTip(imagem9, "População", 0.5, 0.5);
			addChild(ttImagem9);
			var ttImagem10:ToolTip = new ToolTip(imagem10, "Comunidade", 0.5, 0.5);
			addChild(ttImagem10);
			var ttImagem11:ToolTip = new ToolTip(imagem11, "Ecossistema", 0.5, 0.5);
			addChild(ttImagem11);
